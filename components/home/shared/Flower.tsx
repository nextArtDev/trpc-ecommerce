  ...
  useGSAP(
    () => {
      ...
      const allDrawablePaths = gsap.utils.toArray<SVGPathElement>(
        'path[id^=Stroke], path[id^=Stem], #Flourish_1_'
      )
      ...
      const mainStems = '#Stem16_1_, #Stem1_1_'
      const secondaryStems = '#Stem9_1_, #Stem25_1_'
      ...
      tl.set('#Footer_group_1_', { autoAlpha: 1 })
        ...
        .to(
          ...
          { strokeDashoffset: 0, duration: 2, stagger: 0.5 },
          'start+=0.1'
        )
        .to(
          [
        ...
        .to(
          gsap.utils.toArray('#LeftBottomGroup_1_ path[id^=Stroke]').reverse(),
          { strokeDashoffset: 0, duration: 2, stagger: 1 },
          '1'
        )
        .to(
          gsap.utils.toArray('#RightBottomGroup_1_ path[id^=Stroke]').reverse(),
          { strokeDashoffset: 0, duration: 2, stagger: 1 },
          '1'
        )
        .to(
          gsap.utils.toArray('#LeftTopGroup_1_ path[id^=Stroke]').reverse(),
          { strokeDashoffset: 0, duration: 2, stagger: 1 },
          'flower1+=0.5'
        )
        .to(
          gsap.utils.toArray('#RightTopGroup_1_ path[id^=Stroke]').reverse(),
          { strokeDashoffset: 0, duration: 2, stagger: 1 },
          'flower1+=0.5'
        )
        .fromTo(
          dots,
          { autoAlpha: 0 },
          { autoAlpha: 1, ease: 'expo.out', duration: 6 },
          'flower3+=1'
        )
        .fromTo(
          dots,
          { scale: 0, transformOrigin: '50% 50%' },
          { scale: 1, ease: 'expo.out', duration: 5 },
          'flower3'
        )
    },
    { scope: container }
  ...
  return (
    <>
      <style jsx global>{`
        ...
        .flowerFrame [id^='PinkFlowerGroup'],
        .flowerFrame [id^='BaseGroup'] path,
        .flowerFrame [id^='LeafGroup'] path,
        .flowerFrame path[id^='Stroke'],
        .flowerFrame g[id^='BudGroup'] g[id^='BudGroup'] g[id^='Bud'],
        .flowerFrame #Bud8_1_,
        .flowerFrame #Bud10_1_,
        .flowerFrame #Bud23_1_,
        .flowerFrame #Bud26_1_,
        .flowerFrame [id^='Dots'],
        .flowerFrame [id^='Flourish'] {
          visibility: hidden;
        }
        .flowerFrame .st0 {
          fill: #ffffff;
